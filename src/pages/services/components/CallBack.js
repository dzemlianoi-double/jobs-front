        ...
        <div className="row">
          <div className="col-md-12">
            <div className="mu-call-to-action-area">
              <div className="mu-call-to-action-left color-strong-blue-2">
                <h2>{T.translate('callback.caption_callback')}</h2>
                <T.p text="callback.text"/>
              </div>
              <Link to={internal_routes.contacts} className="mu-primary-btn mu-quote-btn bgc-strong-blue-2">Контакты<i className="fa fa-long-arrow-right"></i></Link>
            </div>
          </div>
        </div>
      </div>
